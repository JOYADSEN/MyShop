...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WowShopList', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Best Product Rankings & Reviews', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wowshoplist.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Wow products, best product rankings, solar gear reviews, cheap shopping deals, support UNHCR', // 网站关键词 英文逗号隔开
